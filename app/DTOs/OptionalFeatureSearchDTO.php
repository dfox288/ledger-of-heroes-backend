...
/**
 * Data Transfer Object for OptionalFeature search parameters
 *
 * Properties:
 ...
 */
final readonly class OptionalFeatureSearchDTO
{
    ...
    public static function fromRequest(OptionalFeatureIndexRequest $request): self
    {
