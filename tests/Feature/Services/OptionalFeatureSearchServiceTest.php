...
class OptionalFeatureSearchServiceTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        parent::setUp();
        $this->service = new OptionalFeatureSearchService;
    ...
    {
        $dto = new OptionalFeatureSearchDTO(
            searchQuery: 'invocation',
    ...
    public function it_builds_database_query_with_eager_loading(): void
    {
        ...
        $this->assertArrayHasKey('classes', $eagerLoads);
    ...
    public function it_searches_with_meilisearch_with_search_query(): void
    {
        ...
        $this->assertNotNull($feature, 'Should have optional features in database');
    ...
    #[Test]
    public function it_searches_with_meilisearch_with_class_filter(): void
    {
        $dto = new OptionalFeatureSearchDTO(
            searchQuery: '',
            meilisearchFilter: 'class_slugs IN [warlock]',
            page: 1,
            perPage: 50,
            sortBy: 'name',
            sortDirection: 'asc',
    ...
    {
        $page1Dto = new OptionalFeatureSearchDTO(
            searchQuery: '',
            meilisearchFilter: null,
            page: 1,
            perPage: 3,
        ...
        $page2Dto = new OptionalFeatureSearchDTO(
            searchQuery: '',
            meilisearchFilter: null,
            page: 2,
            perPage: 3,
    ...
    {
        $dto = new OptionalFeatureSearchDTO(
            searchQuery: 'xyznonexistentfeaturexyz123',
            meilisearchFilter: null,
            page: 1,
            perPage: 15,
            sortBy: 'name',
    ...
    public function it_hydrates_eloquent_models_with_relationships(): void
    {
        ...
        foreach ($result->items() as $feature) {
            $this->assertInstanceOf(OptionalFeature::class, $feature);
            $this->assertTrue($feature->relationLoaded('classes'));
            $this->assertTrue($feature->relationLoaded('sources'));
        }
    }
    ...
    {
        $ascDto = new OptionalFeatureSearchDTO(
            searchQuery: '',
            meilisearchFilter: null,
            page: 1,
            perPage: 10,
        ...
        $descDto = new OptionalFeatureSearchDTO(
            searchQuery: '',
            meilisearchFilter: null,
            page: 1,
            perPage: 10,
